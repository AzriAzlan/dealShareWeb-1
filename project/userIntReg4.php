   ...
   <div class="container-fluid h-100">
    ...
    <!--Left panel with name and phone number-->
         <div class="col-md-2" id="leftPanel">
            ...
            <h3 id="userName">MUHAMMAD ALI</h3>
        ...
        <div class="col-md-10">
            ...
            <div class="img-thumbnail py-2 px-3 mb-1" style="background-color: #CAF0F8;">1</div>
            ...
            <p class="lead text-muted pb-3">Tell us about your company!</p>
                ...
                <div class="d-flex mb-1">
            <div class="d-flex flex-column pr-4 align-items-center">
            <div class="img-thumbnail py-2 px-3 mb-1" style="background-color: #CAF0F8;">2</div>
            <div class="line h-100"></div>
            </div>
            <div>
          ...
          <div class="d-flex mb-1">
            <div class="d-flex flex-column pr-4 align-items-center">
            <div class="img-thumbnail py-2 px-3 mb-1" style="background-color: #CAF0F8;">3</div>
            <div class="line h-100"></div>
            </div>
            <div>
          ...
          <div class="d-flex mb-1">
            <div class="d-flex flex-column pr-4 align-items-center">
            <div class="img-thumbnail py-2 px-3 mb-1" style="background-color: #CAF0F8;">4</div>
